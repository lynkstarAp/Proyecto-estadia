...
mac2;
  ...
  createNewUser(id: number) {
    ...
    return {
      ...
      url: "../../../assets/images/users/mcr_min.png",
      neteo: this.meter[this.contador-1].energia_necta_actual
    };
  }
  //---------------------------------------------------------------------------------------
...
;
  ...
  selectMeter() {
    this.medidorService.selectAllMeterEnergy().subscribe(
      (meterFromTheApi: MedidorConsumos) => {
